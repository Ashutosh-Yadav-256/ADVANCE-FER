"""
Streamlit Web Interface for ADVANCE-FER Production Service.
Supports live webcam emotion detection, multi-face analysis, and emotion distribution charts.
"""
...
st.sidebar.divider()
st.sidebar.markdown("### ℹ️ Engine Status")
...
# Mode 3: Test Generator
    ...
    # Create synthetic face-like graphic for verification
    test_img = np.zeros((480, 640, 3), dtype=np.uint8)
    cv2.circle(test_img, (320, 240), 120, (210, 180, 140), -1)  # Face base
    cv2.circle(test_img, (280, 200), 15, (255, 255, 255), -1)    # Eye Left
    cv2.circle(test_img, (360, 200), 15, (255, 255, 255), -1)    # Eye Right
    cv2.circle(test_img, (280, 200), 6, (50, 50, 50), -1)
    cv2.circle(test_img, (360, 200), 6, (50, 50, 50), -1)
    cv2.ellipse(test_img, (320, 280), (40, 20), 0, 0, 180, (50, 50, 200), 4) # Smile
